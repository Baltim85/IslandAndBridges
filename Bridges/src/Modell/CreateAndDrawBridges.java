...
public class CreateAndDrawBridges {
	...
	/**
	 * Konstruktor für die Erstellung und Zeichnung von Brücken bei einem geladenen Spielstand.
	 *
	 * @param islandList   Die Liste der Inseln.
	 * @param listOfB      Die Liste der Brücken.
	 * @param bridges      Die Brückenverbindungen.
	 * @param centerX      Die x-Koordinate des Zentrums.
	 * @param centerY      Die y-Koordinate des Zentrums.
	 * @param delta        Der Delta-Wert für die Berechnungen.
	 * @param width        Die Breite des Spielfelds.
	 * @param height       Die Höhe des Spielfelds.
	 * @param controller   Der BridgeController für die Zeichenoperationen.
	 */
	public CreateAndDrawBridges(ArrayList<Island> islandList, ArrayList<CreateBridges> listOfB, Bridges bridges, int centerX, int centerY,
			int delta, int width, int height, BridgeController controller) {
		// Die Liste der Inseln, die Brücken, die Spielfeldbreite und -höhe sowie den Controller initialisieren
		this.islandList = islandList;
		this.bridges = bridges;
		this.width = width;
		this.height = height;
		...
		// Die Liste der Brücken aus dem Konstruktor-Parameter in die lokale Liste kopieren
		listOfBridge.clear();
		listOfBridge = listOfB;

		// Den BridgeController setzen
		this.controller = controller;

		// Die Zentren für jede Insel berechnen und speichern
		calculateCenterForEachIsland(islandList, centerX, centerY);
	}
	...
	/**
	 * Aktualisiert die Liste der Brücken im BridgeController.
	 * Dies ermöglicht es dem Controller, die Brücken im Spiel zu verwalten.
	 */
	...
	/**
	 * Überprüft, ob das Spiel geladen ist.
	 *
	 * @return true, wenn das Spiel geladen ist, ansonsten false.
	 */
	...
	/**
	 * Setzt den Ladezustand des Spiels.
	 *
	 * @param loaded Der Ladezustand, true wenn das Spiel geladen ist, ansonsten false.
	 */
